...
public class Note extends NoteAbstract implements Cloneable
{
  ...
  public static final short HUNDRED_TWENTY_EIGHTH = LENGTH_RESOLUTION / 2;
	...
	//added by alan- allows for colored representations
  private Color color;
...
//		}
  ...
  public Note (byte heightValue, Accidental accidental) {
   ...
   /**creates an abc note with specific heightValue and color- created by alan*/
    public Note (byte heightValue, Accidental accidental, Color color) {
        super();
        setHeight(heightValue);
        setAccidental(accidental);
        this.color = color;
